...
├── ridl-backend-flatbuffers/   FlatBuffers schema generation over the IR (the second wire backend, ADR-0018)
...
└── decisions/                  Architecture Decision Records
    ...
    └── ADR-0018-flatbuffers-projection-rules.md
```
...
The ADRs present here are 0002 and 0004–0018. ADR-0001 and ADR-0003 are not in
