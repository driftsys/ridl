...
[`2026-09-13-step1-lanes-plan.md`](2026-09-13-step1-lanes-plan.md). Stage A3
executes it on branch `feat/ridl-rt`. Archive it with the spec when lane A lands
(lanes plan §7).
...
note it refines, [`2026-09-08-ridl-rt-design.md`](2026-09-08-ridl-rt-design.md),
supplies the RA-nn rules the spec keeps.
