...
- [`docs/design/codegen-plugins.md`](../design/codegen-plugins.md) §2 and §4:
  the two messages, canonical protobuf JSON on standard input and standard
  output, the path rule, the lookup of `ridlc-gen-<language>` on `PATH`, the
  timeout, and the six failure cases the host reports.
...
- [ADR-0021](../decisions/ADR-0021-ridl-rt-0.1-api-and-release.md) and
  [`docs/design/ridl-rt.md`](../design/ridl-rt.md): the port model the Kotlin
  runtime mirrors, and
  [ADR-0023](../decisions/ADR-0023-interaction-face-generation.md) with
  [`docs/design/interaction-face.md`](../design/interaction-face.md): the face
  the Kotlin face mirrors.
...
- The plugin contract:
  [`../design/codegen-plugins.md`](../design/codegen-plugins.md).
- The frame and its AIDL binding:
  [`../specification/frame-specification.md`](../specification/frame-specification.md)
  §11.2.
- The port model: ADR-0021 and [`../design/ridl-rt.md`](../design/ridl-rt.md).
- The face: ADR-0023 and
  [`../design/interaction-face.md`](../design/interaction-face.md).
- The value objects: [`typl-value-objects-plan.md`](typl-value-objects-plan.md)
  Tasks 3 to 6.
- Model routing:
  [`2026-09-13-step1-lanes-plan.md`](2026-09-13-step1-lanes-plan.md) §4.
