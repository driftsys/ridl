...
- **2026-09-16-lane-c-c4-driver.md** — the driver prompt for lane C's last
  ...
  families instead of the four-seat one the 2026-09-13 prompts describe. It
  carries the model routing Sebastien set on 2026-09-16 and three rules C3 paid
  to learn. Archive it with the lanes plan.
