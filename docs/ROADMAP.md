...
| E6.13 | Closure checks: `system`, component lines, instances and the unit instance, the implicit component, declaration names, resolution (rsdl §3, §6–§8; RSDL-306 to RSDL-312, RSDL-403, RSDL-408, RSDL-409, RSDL-502, RSDL-504, RSDL-601 to RSDL-603, TYPL-009)                                                                 | Appendix A checks with no error, and each code of the group has a fixture that draws it                               | L    |
