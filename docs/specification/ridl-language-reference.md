...
| RIDL-413 | parameter name declared twice in one parameter list (§6.1, §7.1) — a name identifies one parameter; distinct from RIDL-149, which fires only when the two source names collide after the pinned name transform, because these two source names are already the same                                                                                                                                                                                                                                                                                                                                                                                                               | error    |
