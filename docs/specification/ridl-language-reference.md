...
| RIDL-407 | interaction ordinal, or struct field or union arm ordinal (typl §7.4), changed against the published baseline (§11) — the desk-time drift check, emitted by `ridl check`, never by `ridlc`; an enum value's or enum-set bit's reorder is not a change (typl §8, §9) and draws no warning                                                                                                                                                                                                                                                                                                                                                                                          | warning  |
