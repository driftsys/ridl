...
//! `resolve_package`, `check_package`, `service_catalog`, `check_system`).
//! The server is a library; the `ridl` CLI hosts it as `ridl lsp`, which the
//! VS Code extension and the release artifacts use.
//!
